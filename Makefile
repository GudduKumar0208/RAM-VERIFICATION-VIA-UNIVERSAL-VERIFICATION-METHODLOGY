...
SVTB1= ../env/interface.sv ../top/ram_top.sv
INC = +incdir+../env +incdir+../test
SVTB2 = ../test/ram_pkg.sv 
TEST = ../test/ram_test.sv
TEST1 = ../test/test1.sv
TEST2 = ../test/test2.sv
v = ../virtual/ram_virtual.sv
...
sv_cmp:
	vlib $(work)
	vmap work $(work)
	vlog -work $(work) $(RTL) $(SVTB2) $(SVTB1) $(INC) 
    
sv_cmp123:
	vlib $(work)
	vmap work $(work)
	vlog -work $(work) $(RTL) $(SVTB2) $(SVTB1) $(INC) #$(TEST)
